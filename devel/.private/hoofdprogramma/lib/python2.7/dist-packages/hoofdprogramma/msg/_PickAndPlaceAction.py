...
class PickAndPlaceAction(genpy.Message):
  _md5sum = "3a7ed6cba2ab856caf5da43e4212e22d"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d().pack(_x.action_goal.goal.target_pose.position.x, _x.action_goal.goal.target_pose.position.y, _x.action_goal.goal.target_pose.position.z, _x.action_goal.goal.target_pose.orientation.x, _x.action_goal.goal.target_pose.orientation.y, _x.action_goal.goal.target_pose.orientation.z, _x.action_goal.goal.target_pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.target_pose.position.x, _x.action_goal.goal.target_pose.position.y, _x.action_goal.goal.target_pose.position.z, _x.action_goal.goal.target_pose.orientation.x, _x.action_goal.goal.target_pose.orientation.y, _x.action_goal.goal.target_pose.orientation.z, _x.action_goal.goal.target_pose.orientation.w,) = _get_struct_7d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
