...
"""autogenerated by genpy from my_demo/BrushPoseActionResult.msg. Do not edit."""
import codecs
import sys
...
class BrushPoseActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "my_demo/BrushPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_demo/BrushPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BrushPoseActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = my_demo.msg.BrushPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_demo.msg.BrushPoseResult()
